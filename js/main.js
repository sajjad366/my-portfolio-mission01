...
$(function () {
    ...
    $(".tabs a").click(function(e){e.preventDefault();var $this=$(this),$parent=$this.closest("#builder-preview"),tab_id=$this.attr("href"),$tab_group=$parent.find("#tab-group"),$this_video=$parent.find(tab_id),$this_video_source=$this_video.children("source"),$this_video_src=$this_video_source.attr("video-src"),$active_link=$parent.find("a.current-item"),$active_video=$parent.find("video.current-item"),$active_video_height=$active_video.height()
$tab_group.height($active_video_height);$active_link.removeClass("current-item");$active_video.removeClass("current-item").children("source").removeAttr("src");$active_video[0].load();$this_video_source.attr("src",$this_video_src);$this.addClass("current-item");$this_video.addClass("current-item");$this_video[0].load();});
